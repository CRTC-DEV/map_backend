...
class MapItem extends Model
{
    ...
    protected $fillable = ['CadId', 'KeySearch', 'Status', 'CreateDate', 'ModifiDate', 'T2LocationId', 'TitleId', 'DescriptionId', 'ItemTypeId', 'UserId', 'Longitudes', 'Latitudes', 'Rank', 'AreaSide']; // Example fields
