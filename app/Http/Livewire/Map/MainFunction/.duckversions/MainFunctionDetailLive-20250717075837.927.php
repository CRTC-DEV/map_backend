...
class MainFunctionDetailLive extends Component
{
    ...
    {
        $this->logMapPageView('Main Function Detail-20250717075837.927 Page');
    ...
    {
        $this->logMapAttempt('SAVE', 'Main Function Detail Live-20250717075837.927');
    ...
    {
        $this->logMapAttempt('DELETE', 'Main Function Detail Live-20250717075837.927');
