<div class="container-fluid">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            <h1 class="h1">Edit Sub function</h1>
        </div>
    </div>
                    ...
                    <fieldset class="col-md-12 mb-4 border p-3">
                        ...
                        <div class="row">
                            {{-- <div class="col-md-3 mb-3">
                                ...
                                <select wire:model.defer="mainfunction.TitleId" class="form-control" id="titleId">
                             ...
                             <div class="col-md-4 mb-3">
                                ...
                                <input wire:model="mainfunction.title" value="" class="form-control" id="TitleId"
                                    placeholder="Enter TitleId" disabled>
                                @error('mainfunction.TitleId')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                @foreach ($signages as $signage)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                            ...
                                            @if(in_array($signage->Id, $selected_signagesId)) checked @endif>
