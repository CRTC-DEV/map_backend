        ...
        <div class="col-12">
            <form wire:submit.prevent="save">
                ...
                <div class="card card-body border-0 shadow mb-4">
                    ...
                    @if (auth()->guard('user')->user()->role_id != ROLE_STAFF)
                        <div class="row">
                            <div class="col-md 12">
                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="radio radio-primary cursor-pointer">
                                                        <input wire:model="user.role_id" type="radio" name="role" value="{{ROLE_ADMIN}}">
                                                        Admin
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="radio radio-primary cursor-pointer">
                                                        <input wire:model="user.role_id" type="radio" name="role" value="{{ROLE_STAFF}}">
                                                        Staff
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="radio radio-primary cursor-pointer">
                                                        <input wire:model="user.role_id" type="radio" name="role" value="{{ROLE_AUTHOR}}">
                                                        Author
                                                    </label>
                                                </div>
                                            </div>
