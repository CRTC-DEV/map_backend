            ...
            <div class="card card-body border-0 shadow mb-4">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <div class="col-md-3 mb-3">
                        <label for="device_touch_screen.AreaSide">AreaSide</label>
                        <select name="device_touch_screen.AreaSide" wire:model="device_touch_screen.AreaSide" class="form-control mb-0" id="AreaSide">
