            ...
            <div class="card card-body border-0 shadow mb-4">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <div class="col-md-3 mb-3">
                        <label for="device_touch_screen.Airside">Airside</label>
                        <select name="device_touch_screen.Airside" wire:model="device_touch_screen.Airside" class="form-control mb-0" id="Airside">
