            ...
            <div class="card card-body border-0 shadow mb-4">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input wire:model="device_touch_screen.Ip" class="form-control" id="Ip">
                        @error('device_touch_screen.Ip') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-3 mb-3">
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="AreaSide">AreaSide</label>
                        <select name="device_touch_screen.AreaSide" wire:model="device_touch_screen.AreaSide" class="form-control mb-0" id="AreaSide" aria-label="AreaSide select">
                            <option value="1">LandSide</option>
                            <option value="2">AirSide</option>
                        </select>
                        @error('device_touch_screen.AreaSide')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="device_touch_screen.Rotation">Rotation</label>
                        <select name="device_touch_screen.Rotation" wire:model="device_touch_screen.Rotation" class="form-control mb-0" id="Rotation" aria-label="Rotation select">
                            {{-- <option value="{{ null }}">please select</option> --}}
                        ...
                        @error('device_touch_screen.Rotation') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-3 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea wire:model="device_touch_screen.Description" class="form-control" id="Description"></textarea>
                        @error('device_touch_screen.Description') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                </div>
