            ...
            <div class="card card-body border-0 shadow mb-4">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <label for="Airside">Airside</label>
                        <select name="device_touch_screen.Airside" wire:model="device_touch_screen.Airside" class="form-control mb-0" id="Airside" aria-label="Airside select">
                            <option value="0">No</option>
                            <option value="1">Yes</option>
                        </select>
                        @error('device_touch_screen.Airside')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
