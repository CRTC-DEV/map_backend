<div class="container-fluid">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            <h1 class="h1">Add Group Function</h1>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <label for="titleId">Title ID</label>
                                 <select name="GroupFunction.TitleId" wire:model="GroupFunction.titleId"
    ...
    @include('livewire.popup.group_function_modal')
</div>
@section('script')
<script>
        //Transalation
        document.addEventListener('livewire:load', function() {
            Livewire.on('openListGroupFunction', (originalText) => {
                $('#listGroupFunctionModal').modal('show'); // Assuming Bootstrap modal
            });
        });
    </script>
@endsection
