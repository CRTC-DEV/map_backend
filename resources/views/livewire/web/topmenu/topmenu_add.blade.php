        ...
        <form wire:submit.prevent="save">
            ...
            <div class="card card-body border-0 shadow mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="titleId">Title ID</label>
                                 <select name="TopMenu.TitleId" wire:model="TopMenu.titleId"
                            ...
                            <div wire:ignore class="col-md-3 mb-3">
                                ...
                                <input wire:model="TopMenu.OrderIndex" class="form-control" id="OrderIndex"
                ...
                <div class="mt-3 d-flex justify-content-between">
                    <a href="{{ route('admin.topmenu') }}" class="btn btn-secondary btn-icon-split">
