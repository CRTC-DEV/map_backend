                    ...
                    <fieldset class="col-md-12 mb-4 border p-3">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <select wire:model.defer="SubMenu.TitleId" class="form-control" id="titleId">
                            ...
                            <div wire:ignore class="col-md-12 mb-3">
                                ...
                                <textarea wire:model="SubMenu.OrderIndex" class="form-control" id="OrderIndex"
