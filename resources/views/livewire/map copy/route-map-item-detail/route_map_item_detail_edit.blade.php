            ...
            <div class="card card-body border-0 shadow mb-4">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="route_map_item_detail.RouteMapItemId" wire:model="route_map_item_detail.RouteMapItemId" class="form-control mb-0" id="Status" aria-label="Gender select example">
