<div class="container-fluid">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            <h1 class="h1">Add Signage MapItem</h1>
        </div>
    </div>
    ...
    {{-- @include('livewire.popup.list_signage_MapItem_modal') --}}
</div>
@section('script')
    <script>
        //Transalation
        document.addEventListener('livewire:load', function() {
            Livewire.on('openListMapItemSignage', (originalText) => {
                $('#listMapItemSignageModal').modal('show'); // Assuming Bootstrap modal
            });
        });
    </script>
@endsection
